...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_biomedical_equipment_serial_number"),
        "biomedical_equipment",
        ["serial_number"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_patients_medical_record"), "patients", ["medical_record"], unique=True
    )
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "TECHNICIAN", "DOCTOR", name="user_role"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            sa.Enum(
                "CREATE", "UPDATE", "DELETE", "VALIDATE", "LOGIN", name="audit_action"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_calibrations_equipment_id"),
        "calibrations",
        ["equipment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calibrations_next_calibration_date"),
        "calibrations",
    ...
    op.create_table(
        ...
        sa.Column(
            "sample_type",
            sa.Enum("BLOOD", "URINE", "SALIVA", "TISSUE", "OTHER", name="sample_type"),
            nullable=False,
        ),
        sa.Column(
            "status",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_calibrations_next_calibration_date"), table_name="calibrations"
    )
    ...
    op.drop_index(
        op.f("ix_biomedical_equipment_serial_number"), table_name="biomedical_equipment"
    )
