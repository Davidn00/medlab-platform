...
def test_login_rate_limit_allows_first_attempt(mock_get_redis):
    ...
    assert check_login_rate_limit("127.0.0.1:test@example.com")
...
def test_login_rate_limit_blocks_excess_attempts(
    ...
    assert not check_login_rate_limit("127.0.0.1:test@example.com")
...
def test_clear_login_rate_limit(mock_get_redis):
    ...
    clear_login_rate_limit("127.0.0.1:test@example.com")
