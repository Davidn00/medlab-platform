...
def test_result_task_processes_test_and_closes_session():
    ...
    with patch(
        ...
        "app.services.laboratory_result_service."
        "LaboratoryResultService",
        return_value=service,
    ):
        result = process_laboratory_result.run(
